...
from APP_FILMS_164.employe.gestion_employe_wtf_forms import FormWTFAjouterChantier
from APP_FILMS_164.employe.gestion_employe_wtf_forms import FormWTFDeleteChantier
from APP_FILMS_164.employe.gestion_employe_wtf_forms import FormWTFUpdateChantier
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_employe = """INSERT INTO t_Chantier (id_Chantier, Rue, Cp, Ville, Etage, Pays, Date_debut, 
                Date_fin, statut) 
    ...
    try:
        if request.method == "POST" and form_update.submit.data:
            ...
            str_sql_update_chantier = """UPDATE t_Chantier SET Rue = %(value_rue)s, 
                                        ...
                                        WHERE ID_Chantier = %(value_id_employe)s"""
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_employe = "SELECT * FROM t_Chantier WHERE ID_Chantier = %(value_id_employe)s"
...
def employe_delete_wtf():
    ...
    try:
        ...
        if request.method == "GET":
            ...
            str_sql_employe_films_delete = """SELECT * FROM t_chantier_materiel 
