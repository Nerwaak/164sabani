    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO t_Chantier (id_Chantier,Ville) VALUES (NULL,%(value_intitule_genre)s) """
...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            nom_rue_update = form_update.nom_rue_update_wtf.date
...
def genre_delete_wtf():
    ...
    try:
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT * FROM t_chantier_materiel 
